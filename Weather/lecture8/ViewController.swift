...
class ViewController: UIViewController {
    ...
    func fetchData(){
        let URL = "https://api.openweathermap.org/data/2.5/onecall?lat=\(Constants.lat)&lon=\(Constants.lon)&exclude=minutely,alerts&appid=0e9477e67e53c8c91844f7d87860ae02&units=metric"
    ...
    @IBAction func valueChanged(_ sender: Any) {
        ...
        case 2:
            Constants.lat = "44.85278"
            Constants.lon = "65.50917"
        default:
            break
        }
